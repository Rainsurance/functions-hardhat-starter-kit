...
contract RainRiskpool is BasicRiskpool, AccessControl {
  ...
  function grantInvestorRole(address investor) external onlyOwner {
  ...
  ) public override onlyRole(INVESTOR_ROLE) returns (uint256 bundleId) {
